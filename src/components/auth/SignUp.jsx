...
function SignUp() {
  ...
  return (
    <div className='flex  items-center bg-black justify-evenly '>
      ...
      <div className='bg-black h-screen  overflow-x-hidden overflow-y-scroll  flex flex-col items-center justify-center '>
        ...
        <h1 className='text-2xl text-primary-content mb-4 font-bold block  z-10 '>Sign up</h1>
        <div className='bg-base-100 z-10 p-2 rounded-lg'>
